<div style="display: flex;justify-content: center; background-color: #f1eff1e0;padding: 14px">
    <div>
        ...
        <div
            ...
            <p style="font-size: 22px;">Se realizo un pedido a Nombre de:
                {{ $nombres }}.</p>
        </div>

        <div
            style="width: 100% ;border-radius: 10px;background-color: rgba(255, 255, 255, 0.842); margin-bottom: 10px; margin-top:20px; padding: 15px;">
            <h2 style="color: blueviolet; font-size: 20px;">Monto total de la Compra que
                realizaste</h2>
        ...
        <div
            style="width: 100% ;border-radius: 10px;background-color: rgba(255, 255, 255, 0.842); margin-bottom: 10px; margin-top:20px; padding: 15px;">
            <h2 style="color: blueviolet; font-size: 20px;">Socios</h2>
