            ...
            <div class="contenido-menu">
                <nav>
                    <ul class="menu-item">
                        ...
                        <li class="item"><a href="{{ route('cart.index') }}">Mi carrito<svg
                                    xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-shopping-cart"
                                    width="28" height="28" viewBox="0 0 24 24" stroke-width="2" stroke="#00b341"
                ...
                <div class="navegador-flex">
                    ...
                    <a href="{{ route('cart.index') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-shopping-cart"
                            ...
                            <path d="M17 17h-11v-14h-2" />
                            <path d="M6 5l14 1l-1 7h-13" />
                        </svg>(<span class="boton-sin-color contador-carrito"></span>)
                    </a>
