                            ...
                            <form action="{{ route('admin.provider.update', ['provider' => $provider]) }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nombres" name="nombres" class="form-control espacio-abajo"
                                        placeholder="Nombres" autocomplete="off" value="{{ $provider->nombres }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="tipo_documento" class="form-select espacio-abajo"
                                                id="tipo_documento">
                                                <option value="{{ $provider->tipo_documento }}">
                                                    {{ $provider->tipo_documento }}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="numero_documento" name="numero_documento"
                                                ...
                                                autocomplete="off" value="{{ $provider->numero_documento }}" readonly>
                                            {{-- VALIDACION CON VALIDATE --}}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="direccion" name="direccion" class="form-control espacio-abajo"
                                        placeholder="direccion" autocomplete="off" value="{{ $provider->direccion }}">
                                    {{-- VALIDACION CON VALIDATE --}}
                                    @error('direccion')
                                        <p class="error-registro-usuario">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="telefono" name="telefono" class="form-control espacio-abajo"
                                        placeholder="telefono" autocomplete="off" value="{{ $provider->telefono }}">
                                    {{-- VALIDACION CON VALIDATE --}}
                                    @error('telefono')
                                        <p class="error-registro-usuario">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" id="email" name="email" class="form-control espacio-abajo"
                                        placeholder="email" autocomplete="off" value="{{ $provider->email }}">
                                    {{-- VALIDACION CON VALIDATE --}}
                                    @error('email')
                                        <p class="error-registro-usuario">{{ $message }}</p>
                                    @enderror
